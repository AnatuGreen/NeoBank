...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} mb-8 w-full flex-col md:flex-row`}>
      <div className={`mr-10 flex-col justify-start`}>
        <img
          src={logo}
          alt="Bank logo"
    ...
    <div className="flex w-full flex-col items-center justify-between border-t-[1px] border-t-[#3F3E45] pt-6 md:flex-row ">
      <p className="mb-4 text-center font-poppins text-[18px] font-normal leading-[27px] text-white">
        Copyright ©️ {new Date().getFullYear()} NeoBank by Anaturuchi
        @AnatuTech. All Rights Reserved.
      </p>
